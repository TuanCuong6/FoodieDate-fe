      ...
      <div className="space-y-6">
                ...
                <select
                  ...
                  onChange={(e) => {
                    ...
                    handleStatusChange(
                      value === ""
                        ? undefined
                        : (parseInt(value) as RestaurantStatus),
                    );
                  }}
                  className="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-rose-500"
                >
        ...
        {filteredRestaurants.length === 0 ? (
          <div className="bg-white rounded-2xl p-12 text-center shadow-lg">
            ...
            <p className="text-gray-600">Thêm quán ăn đầu tiên của bạn</p>
          </div>
        ) : (
                ...
                >
                  <div className="relative h-28">
                    ...
                    <div className="absolute bottom-3 left-4 right-4 flex items-end justify-between gap-3">
                      ...
                      <div
                        className={`${config.bgColor} px-2 py-1 rounded-full flex items-center space-x-1 shrink-0`}
                      >
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setPlanForm({ ...planForm, planDate: e.target.value })
                    }
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setPlanForm({ ...planForm, planTime: e.target.value })
                    }
                    className="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-rose-500"
                  />
                </div>
