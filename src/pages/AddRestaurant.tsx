...
import { getRestaurantCoverUrl } from "../data/seedRestaurants";
...
export default function AddRestaurant() {
  ...
  const coverUrl = getRestaurantCoverUrl(
    formData.name || "Quán ăn",
    formData.notes,
  );
        ...
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-rose-50 via-white to-orange-50 border border-rose-100 shadow-lg">
          ...
          <div className="relative p-6 sm:p-8">
            ...
            <p className="text-gray-600 mt-2">
              Lưu một địa điểm “đáng thử” để lần hẹn tiếp theo khỏi phải nghĩ.
            </p>
          </div>
        </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-blue-800 mb-3">
                      Dán link từ TikTok, Facebook, Instagram để tự động điền
                      thông tin
                    </p>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value={RestaurantStatus.KhongThich}>
                        Không thích
                      </option>
                    </select>
                  </div>
                ...
                <div className="flex items-center space-x-4 pt-6 border-t border-gray-200">
                  <button
                    ...
                    className={`flex-1 bg-gradient-to-r from-rose-500 to-orange-500 text-white py-3 rounded-xl font-semibold hover:shadow-lg transition-all flex items-center justify-center space-x-2 ${
            ...
            <div className="lg:sticky lg:top-24 space-y-4">
              <div className="bg-white rounded-3xl overflow-hidden border border-gray-100 shadow-lg">
                <div className="relative h-40">
                  ...
                  <div className="absolute bottom-4 left-5 right-5">
                    <div className="text-white font-bold text-xl leading-tight line-clamp-2">
                      {formData.name || "Tên quán sẽ hiện ở đây"}
                    </div>
              ...
              <div className="bg-white rounded-3xl p-5 border border-gray-100 shadow-sm">
                ...
                <div className="text-sm text-gray-600 mt-2">
                  Điền “Ghi chú” theo format:
                </div>
                <div className="mt-2 text-sm text-gray-700 bg-gray-50 border border-gray-100 rounded-2xl p-3">
                  Món nên thử • Giá ước tính • Vibe • Lưu ý đặt bàn
                </div>
              </div>
            </div>
          </div>
